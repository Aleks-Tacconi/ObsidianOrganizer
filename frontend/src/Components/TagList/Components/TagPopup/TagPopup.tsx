        ...
        <div className="popup">
            <div className="popup-content">
                <div style={{ display: "flex", alignItems: "center" }}>
                    <TextField label="Tag Name" variant="outlined" value={name} onChange={(e) => setName(e.target.value)} sx={{ width: "100%" }} />
                    <div
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                    {subtags.map((subtag, i) => (
                        <SubtagItem key={i} subtag={subtag} onChange={(name) => updateSubtag(i, name)} onRemove={() => removeSubtag(i)} />
                    ))}
